...
export default function App() {
  ...
  const [userRole, setUserRole] = useState<UserRole>('INSTITUTIONAL_ISSUER');
  ...
  const handleLoginSuccess = (role: UserRole, email: string, name: string, institutionId?: string) => {
    ...
    if (role === 'INSTITUTIONAL_ISSUER') {
      setCurrentTab('issuer');
  ...
  return (
    <div className="relative min-h-screen bg-slate-950 text-slate-100 flex flex-col font-sans selection:bg-cyan-500 selection:text-white overflow-x-hidden">
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        {/* Render Login Page as 1st screen if not authenticated */}
        {!isAuthenticated ? (
