...
export default {
    ...
    DB_PATH: isVercel ? path.join(tmpDir, 'truthseal.db') : path.join(process.cwd(), 'src', 'backend', 'data', 'truthseal.db'),
    UPLOAD_DIR: isVercel ? path.join(tmpDir, 'uploads') : path.join(process.cwd(), 'src', 'backend', 'data', 'uploads'),
