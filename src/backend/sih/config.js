...
module.exports = {
    ...
    DB_PATH: isVercel ? path.join(tmpDir, 'truthseal.db') : path.join(__dirname, '..', 'data', 'truthseal.db'),
    UPLOAD_DIR: isVercel ? path.join(tmpDir, 'uploads') : path.join(__dirname, '..', 'data', 'uploads'),
